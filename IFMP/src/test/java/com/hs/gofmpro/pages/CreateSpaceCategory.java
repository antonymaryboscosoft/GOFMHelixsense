...
//Create SpaceCategory
			...
			@FindBy(xpath="//input[@id='o_field_input_408']")
			WebElement Sequence;
...
//Initializing the Page Objects:
		...
		public CreateEquipmentCategory createSpaceCat(String EnterSNa) throws InterruptedException{
			...
			for(int rowNum = 2; rowNum<= rowCount; rowNum++){
				String name=reader.getCellData("GofmInput", "EnterSName", rowCount);
				System.out.println("Name:"+name);
					
				driver.findElement(By.xpath("//input[@name='name']")).sendKeys(EnterSNa);
				Thread.sleep(1000);
